...
validation step** — and it argues for those testers reporting through the public
issue tracker rather than only by email, which is a change to how the feedback
links in review §14.5 should be framed for them specifically.
